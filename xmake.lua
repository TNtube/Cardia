...
add_requires("imgui v1.89-docking", {configs = {glfw= true, opengl3 = true}})
...
add_requireconfs("imguizmo.imgui", {override = true, version = "v1.89-docking", configs = {glfw= true, opengl3 = true}}) -- config sub imgui module
