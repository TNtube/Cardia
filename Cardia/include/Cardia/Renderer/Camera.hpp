...
namespace Cardia {
	...
	public:
		...
		virtual const glm::vec3& getPosition() { cdCoreAssert(false, "getPosition not implemented. Override this method in your class or use an external transform"); return m_Position; }
	protected:
